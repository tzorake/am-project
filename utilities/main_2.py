...
# from PySide6.QtWidgets import (QApplication, QPushButton, QHBoxLayout, QVBoxLayout, QWidget, QScrollArea, QLabel, QMainWindow)
...
class LESSSAMap(QtWidgets.QWidget):
    def __init__(self, parent = None):
        ...
        self.map.setStyleSheet(u"background-color: rgba(255, 0, 255, 50)")
